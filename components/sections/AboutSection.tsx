...
/**
 * ABOUT SECTION — why FABINS retrofits existing frames instead of replacing them.
 *
  ...
  <section id="about" className="py-24 sm:py-28">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <SectionHeader
        ...
        description="Importing complete automated inspection machines from abroad requires millions in capital expenditure and disruptive factory floor redesign. FABINS upgrades the inspection frames already sitting in Bangladeshi mills."
      />
